...
int main(){
    ...
    calculadora:
    {
        ...
        case 3:{
            ...
            sf("%f",&num2);
            r=num1*num2;
            pf("\vEl resultado de la multiplicación es: %f\n",r);
        }
            break;
        case 4:{
            system("clear");
            ...
            sf("%f",&num2);
            if(num2==0){ 
            pf("No se puede dividir entre 0.\n");
            }
            else{ 
            r=num1/num2;
            pf("\vEl resultado de la división es: %f\n",r);
            }
        }
            break;
        case 5:{
        ...
        case 6:{
            ...
            sf("%f",&num1);
            if(num1<0){ 
            pf("En los números reales no existe la raíz cuadrada de números negativos.\n");
            }
            else{
            r=sqrt(num1);
            pf("\vEl resultado de la raíz cuadrada es: %f\n",r);
            }   
        }
            break;
        default:
